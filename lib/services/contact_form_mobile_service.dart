// UNUSED FILE because is not secure with mailer/smtp because the personal configuration data will be visible (HOST, PORT, MAIL, PASSWORD) in front.
// // Version with files and without the unnecessary lines in the sent message (formatting of null values) and files
// import 'dart:io';
...
//   // Without wrapper ContactFormData
...
//   // // With wrapper ContactFormData (below)
//   // static Future<void> submitContactForm({
//   //   required GlobalKey<FormState> formKey,
//   //   required BuildContext context,
//   //   TextEditingController? requestTypeController,                
//   //   required ContactFormData data,
//   //   required Function(bool) setIsSending, // Manages the loading state in the UI (e.g. disabling the button, showing a loading indicator)
//   //   required Function(bool) setMessageSendingValidated, // Give the information if the message was sent (true/false) to the parent
//   // }) async {
...
//       for (var picked in files) {
//         message.attachments.add(
//           FileAttachment(File(picked.file.path))
//             ..location = Location.attachment
//             .. cid = picked.file.name
//         );
//       }
//     }
...
// // Wrapper to avoid managing a long list of parameters.
