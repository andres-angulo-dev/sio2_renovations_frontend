...
//               currentItem == "Accueil" ? GlobalLogo.whiteLogo : GlobalLogo.blackLogo,
...
//       actions: mobile ? null 
//       : [ NavItems(
//         defaultColor: currentItem == "Accueil" ? GlobalColors.firstColor : GlobalColors.secondColor, 
...
// // App bar without color change on scroll and content across the entire width
// import 'package:flutter/material.dart';
// import 'package:flutter_svg/svg.dart';
// import 'nav_items.dart';
// import '../utils/global_colors.dart';
...
//           width: mobile ? 250 : MediaQuery.of(context).size.width * 0.9,
//           child: Row(
...
//         )
//       ),
//       // Menu management depending on whether the screen size is mobile or web
//       actions: mobile ? null 
//       : [ NavItems(
//         defaultColor: currentItem == "Accueil" ? GlobalColors.firstColor : GlobalColors.secondColor, 
//         hoverColor: GlobalColors.orangeColor, 
...
class MyAppBarComponentState extends State<MyAppBarComponent> {
  ...
  @override
  Widget build(BuildContext context) {
    final mobile = GlobalSizes.isMobileScreen(context);
