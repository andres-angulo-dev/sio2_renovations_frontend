// With the horizontal menu widget
                      ...
                      Container(
                        ...
                        decoration: const BoxDecoration(
                          image: DecorationImage(
                            image: AssetImage(GlobalImages.projectsScreenWelcomeImage), 
...
// // With the included horizontal menu 
// import 'package:flutter/material.dart';
// import 'package:visibility_detector/visibility_detector.dart';
// import '../components/my_nav_bar_component.dart';
// import '../components/my_drawer_component.dart';
...
//     if (selectedService == 'TOUT VOIR') {
//       // Combine all the photos method 1
...
//       // // Combine all the photos method 2
//       // final List<String> allPhotos = [];
//       // GlobalData.photosWall.forEach((service, photos) {
//       //   allPhotos.addAll(photos);
//       // });
...
//                                   decoration: BoxDecoration(
//                                     border: Border.all(
//                                       color: selectedService.toLowerCase() == service['title']!.toLowerCase() ? GlobalColors.thirdColor : Colors.transparent,
//                                       width: 3.0,
//                                     ),
//                                   ),
//                                   child: MouseRegion(
